    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                <div class="sidebar-brand-text mx-3">SOLO Learning</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Laporan Pengajuan</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="dataMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Master User</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                ...
                                                <i class="fas fa-arrow-right mr-2"></i> Ubah Berita
                                                Website
                                            </button>
                                        </div>
                                    </div>
